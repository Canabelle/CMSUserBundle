...
use Canabelle\WebBundle\Controller\SecuredCRUDController;
use Canabelle\WebBundle\HttpFoundation\AjaxResponse;
        ...
        if ($success) {
            ...
            if ($success) {
                ...
                if (!$this->admin->isAdmin()) {
                    ...
                    $user = $this->get('doctrine.orm.entity_manager')->getRepository('CanabelleCMSUserBundle:User')->find($userId);
                }
