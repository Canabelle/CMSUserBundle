...
namespace Canabelle\CMSUserBundle\Controller;
...
class ResettingFOSUser1Controller extends \Sonata\UserBundle\Controller\ResettingFOSUser1Controller
{
    ...
    public function sendEmailAction()
    {
        ...
        foreach($users as $user) {
            ...
            try {
                $this->container->get('canabelle.web.grubmailer')->getMailer()->send(
                    'CanabelleCMSUserBundle:Resetting:email',
                    array('no-reply@' . $this->container->getParameter('canabelle.web.email_hostname') => $this->container->getParameter('canabelle.web.email_title')),
                    $recipients,
                ...
                $this->container->get('canabelle.web.exception_handler')->handle($e);
            }
